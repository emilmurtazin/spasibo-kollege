...
DEMO_REWARDS = [
    ...
    ('Обед с руководителем', 'Личная встреча и обед с CEO или вашим руководителем.', 100, 'event'),
    ('Дополнительный выходной', 'Один дополнительный оплачиваемый день отдыха.', 40, 'wellbeing'),
